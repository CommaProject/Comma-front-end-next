  ...
  <style.Wrapper>
    ...
    {switchActiveCategory === 1 && (
      ...
      >
        ...
        <style.Slide>
          <ArtistDetailForm
            artistImage={spotifyArtistForDetailArtist? spotifyArtistForDetailArtist.images[2].url:""}
            artistName= {spotifyArtistForDetailArtist? spotifyArtistForDetailArtist.artistName :""}
